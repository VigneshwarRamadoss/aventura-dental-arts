...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', as: Component = 'button', loading, children, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-gradient-to-b from-[#FFFFFF] to-[#EAE8E8] text-charcoal border border-white/60 shadow-[0_4px_14px_0_rgba(0,0,0,0.05)] h-12 px-8 rounded-full font-serif text-base hover:shadow-[0_6px_20px_rgba(255,255,255,0.15)] hover:to-[#F5F4F4] hover:-translate-y-[1px] active:scale-95 focus:outline-none focus:ring-2 focus:ring-bronze focus:ring-offset-2 focus:ring-offset-charcoal transition-all duration-[400ms] ease-out",
